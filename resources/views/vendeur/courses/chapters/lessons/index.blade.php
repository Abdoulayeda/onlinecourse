...
@section('content')
    <div>
        ...
        <p class="text-2xl text-fold my-4"> {{ $chapter->title }}</p>
                    ...
                    @foreach ($chapter->lessons as $lesson)
                        <tr class=" border-b text-xl">
                            ...
                            <td>
                                ...
                                <a href="{{ route('lesson.images', $lesson->id) }}" class="text-gray-800">
                            ...
                            <td class=" border-b text-xl">
                                <a href="{{ route('lesson.contenu', $lesson->id) }}" class="text-gray-800">
                                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('content.preview', $lesson->slug) }}"
