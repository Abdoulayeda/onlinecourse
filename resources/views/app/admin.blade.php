            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#" class="flex items-center p-2  rounded-lg text-white  group">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Vendeurs</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('categorie.create') }}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Ajouter un categorie</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    ...
                    <form action="{{ route('logout') }}" method="post">
                        ...
                        <div
                            ...
                            <button class="flex-1 ml-3 whitespace-nowrap">LogOut</button>
                        </div>
